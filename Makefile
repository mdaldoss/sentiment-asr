...
.PHONY: help setup test lint data train eval report demo all record gen-probe gen-synthetic clean
...
gen-probe:  ## [needs CARTESIA_API_KEY] D0 emotion-space probe
	uv run python scripts/gen_emotion_probe.py

gen-synthetic:  ## [needs CARTESIA_API_KEY] E2 incongruence set
